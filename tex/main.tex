...
give a more in depth description of the analog front end and the FPGA board.\begin{figure}[htb]
    \centering
...
Be advised to always use the latest driver versions, which are not necessarily included in
