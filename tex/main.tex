...
that the intermodulation products shown in \cref{fig:rxip3} are caused by Part B in \cref{fig:usrp}.
...
$1\cdot{}x+a$. The point were both curves intersect is called the third order intercept point.
