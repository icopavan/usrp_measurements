...
A detailed overview can be seen in \cref{fig:usrp}.\begin{figure}[htb]
    \centering
...
they are clipped to \SI{16}{\bit}. %TODO dsp core connection points
\subsection{DSP TX chain}
\label{sec:dsptx}
\begin{figure}[htb]
    \centering
\resizebox{\textwidth}{!}{
