...
one with eight taps and a small one with four taps. Both half band filters can be
...
\end{tikzpicture}
    ...
    \caption{\gls{dsp} \gls{tx} chain. Stroked lines indicate the bit width used.}
    \label{fig:txpath}
\end{figure}
