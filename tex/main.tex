...
\begin{tikzpicture}
    \matrix (m1) [row sep=5mm, column sep=5mm]
    {
        ...
        \node[coordinate]                           (m04) {};       &
        \node[coordinate]                           (m05) {};       &
        \node[dspmixer,dsp/label=above]             (m06) {mag};    \\
        %------------------------------------------------------------
        &
        ...
        \node[coordinate]                           (m17) {};       &
        \node[coordinate]                           (m18) {};       &
        \node[dspsquare,label=above:{phase}]        (m19) {$\sum$}; \\
        %------------------------------------------------------------
        &
        \node[coordinate]                           (m20) {};       &
        \node[coordinate]                           (m21) {};       &
        ...
        \node[dspsquare]                            (m210) {\upsamplertext{L}};     &
        \node[dspsquare]                            (m211) {\downsamplertext{M}};     &
        \node[coordinate]                           (m212) {};       &
        \\
        %------------------------------------------------------------
        &
        ...
        \node[coordinate]                           (m44) {};       &
        \node[coordinate]                           (m45) {};       &
        \node[dspmixer,dsp/label=below]             (m46) {phase};  \\
        %------------------------------------------------------------
        &
        ...
        \node[coordinate]                           (m74) {};       &
        \node[coordinate]                           (m75) {};       &
        \node[dspnodeopen,dsp/label=below]          (m76) {sample}; &
        \node[coordinate]                           (m77) {};       &
        \node[coordinate]                           (m78) {};       &
        \node[coordinate]                           (m79) {};       &
        \node[dspsquare]                            (m710) {hb};    &
        \node[dspsquare]                            (m711) {small\_hb};     &
        \node[coordinate]                           (m712) {};      \\
        %------------------------------------------------------------
        &
        \node[coordinate]                           (m80) {};       &
    ...
    \end{scope}
    \foreach \i [evaluate = \i as \j using int(\i+1),] in {7,9,10}
    {
        \begin{scope}[dspconn]
            \draw ([yshift=1mm]m2\i.east) -- ([yshift=1mm]m2\j.west);
            \draw ([yshift=-1mm]m2\i.east) -- ([yshift=-1mm]m2\j.west);
        \end{scope}
    }

    %connections top row -> bottom row
    \foreach \off in {1mm,-1mm}
    {
        \draw[dspline] ([yshift=\off]m211.east) -- ([yshift=\off,xshift=\off]m212) -- ([yshift=\off,xshift=\off]m712);
        \draw[dspconn] ([yshift=\off,xshift=\off]m712) -- ([yshift=\off]m711.east);
    }

    %bottom row right -> left
    \foreach \i [evaluate = \i as \j using int(\i-1),] in {11}
    {
        \begin{scope}[dspconn]
            \draw ([yshift=1mm]m7\i.west) -- ([yshift=1mm]m7\j.east);
            \draw ([yshift=-1mm]m7\i.west) -- ([yshift=-1mm]m7\j.east);
        \end{scope}
    }

    \foreach \off/\i in {1mm/6,-1mm/8}
    {
        \draw[dspline] ([yshift=\off]m710.west) -- ([yshift=\off]m79) -- (m\i9);
        \draw[dspconn] (m\i9) -- (m\i8);
        \draw[dspline] (m\i8) -- (m\i7) -- (m77);
    }
    \draw[dspflow] (m77) -- (m76.east);
    ...
    \node[draw,inner xsep=5pt,inner ysep=20pt,dashed,fit=(m15) (m06) (m46) (m37),label=above:{correction}] {};
    \node[draw,inner xsep=10pt,inner ysep=20pt,dashed,fit=(m68) (m88),label=below:{scale}] {};
\end{tikzpicture}
    \caption{DSP Rx Path}
    \label{fig:rxpath}
\end{figure}
