...
\begin{tikzpicture}
    \begin{axis}[
        ...
        \addplot[domain = -93:-35, samples = 201, dashed] {1*x+33.0765};
        \addplot[domain = -93:-35, samples = 201, dotted] {3*x+111.2541};
        \legend{out,$IM$,$IM_3$}
    \end{axis}
\end{tikzpicture}
    \caption{RX IP3}
...
\begin{tikzpicture}
    \begin{axis}[
        ...
        \addplot[domain = -27:17, samples = 201,dotted] {0.9951*x-4.3113};
        \addplot[domain = -27:17, samples = 201,dotted] {3.0347*x-33.2647};
