...
\begin{tikzpicture}
    \begin{axis}[
        ...
        \addplot[domain = -60:-5, samples = 201] {0.9117*x+88.0799};
        \addplot[domain = -60:-5, samples = 201] {3.0918*x+110.8365};
...
\begin{tikzpicture}
    \begin{axis}[
        ...
        \addplot[domain = -20:15, samples = 201] {0.9911*x-10.8085};
        \addplot[domain = -20:15, samples = 201] {3.3325*x-39.1148};
        \legend{$L_a$,$L_{IM3}$,$IM3$}
    \end{axis}
\end{tikzpicture}
