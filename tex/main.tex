...
Two amplitudes were used in the measurement: $0.8 \times \text{full scale}$, for measuring
samples in the linear region of the \gls{dac}, and full scale to measure the absolute
maximum value.

To get the results at the output port of the \gls{usrp}, the measurement data was corrected
by the forward gain of the cable with the attenuator attached.
