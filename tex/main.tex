...
\resizebox{\linewidth}{!}{
        \begin{tikzpicture}
            ...
            \draw node[dspsquare,above=of isaA2,label=above:Stage $N$] (isdA2) {$z^{-1}$};
            \draw node[dspsquare,right=of isaA2] (sw) {$\downsamplertext{R}$};
            \draw node[dspadder,right=of sw] (isaB1) {};
            \draw node[dspsquare,above=of isaB1,label=above:Stage 1] (isdB1) {$z^{-2}$};
            \draw node[right=of isaB1] (contB1) {$\dotsc$};
            \draw node[above=of contB1] {$\dotsc$};
            \draw node[dspadder,right=of contB1] (isaB2) {};
            \draw node[dspsquare,above=of isaB2,label=above:Stage $N$] (isdB2) {$z^{-2}$};
    ...
    \begin{subfigure}[c]{.5\linewidth}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[black,domain=0:2,samples=501,name path=A] {10*log10((sin(deg(pi*2*x))/sin(deg(pi*x/4)))^8) - 72.24};
                ...
                \draw (0.125,0) node[anchor=base west] {\scriptsize $f_c$};
                \draw[dashed] (0.875,-150) -- (0.875,\pgfkeysvalueof{/pgfplots/ymax});
                \draw (1,0) node[anchor=base] {\scriptsize $2\cdot{}f_c$};
