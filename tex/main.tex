...
The setup for measuring the \gls{rx} \gls{if} frequency response can be seen in
\cref{fig:rxifsetup}. For power measurements a spectrum analyzer has been used
...
In \cref{fig:iftx50} the effect of the \SI{20}{\mega\hertz} filter mentioned in \cref{sec:usrp} is
observable.
