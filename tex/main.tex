...
\clearpage
\begin{abstract}
The software defined radio platform characterized in this bachelor thesis is Ettus
Research \gls{usrp}. The characterization consists of a \gls{rf} frequency response,
a \gls{if} frequency response and the intermodulation properties. Small signal
...
After this GNU Radio and matlab scripts, to automate the measurements, were
developed. GNU Radio usage is described in this work based on these scripts.

The processed results, measurement setups, and discussions can be found in
the second part of this work.

The third part contains a summary, conclusions and ideas for further work.
...
In \cref{fig:iftx50} the effect of the LP5 filter, which has a cut off frequency
of \SI{20}{\mega\hertz} mentioned in \cref{sec:usrp} is also observable.
